...
class Ponpes1Controller extends Controller
{
    public function index()
    {
        ...
        $employee = Cache::remember('employee4', 3600, function () {
            return app('App\Helpers\BoardingSchool')->employee();
        });
        $alumni = Cache::remember('alumni5', 3600, function () {
    ...
    public function tentang()
    {
        ...
        $profil = Cache::remember('profil0', 3600, function () {
            return app('App\Helpers\BoardingSchool')->profile();
        });
        $album = Cache::remember('album0', 3600, function () {
            return app('App\Helpers\BoardingSchool')->album();
        });
        $employee = Cache::remember('employee0', 3600, function () {
            return app('App\Helpers\BoardingSchool')->employee();
        });
        // $profil = Cache::get('profil');
        // dd($profil);
    ...
    public function detail_album()
    {
        ...
        $album = Cache::remember('album0' . rand(1, 99999), 3600, function () {
            return app('App\Helpers\BoardingSchool')->album();
        });
        $profil = Cache::remember('profil0', 3600, function () {
            return app('App\Helpers\BoardingSchool')->profile();
    ...
    public function kontak()
    {
        ...
        $profil = Cache::remember('profil5', 3600, function () {
            return app('App\Helpers\BoardingSchool')->profile();
        });
        // $profil = Cache::get('profil');
        // dd($profil);
